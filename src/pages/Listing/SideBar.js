        ...
        return (
            <div className="col-lg-4 col-12 ">
                <aside className="sidebar">
                    ...
                    <div className="widget-listing abt-listing bd_top">
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <h5 className="mb-15">Price:
                                          ₹ <span className="range-value">1000</span>
                                        </h5>
                ...
                <aside className="sidebar mt-3 mb-4">
                    <div className="widget-listing abt-listing bd_top">
                        <div className="filter-box">
                            <form action="#" method="post">
                                <div className="row">
                                    <div className="col-12 text-center">
                                        <h4 className="mb-2">Can't decide?</h4>
                                        <p className="mb-2">Get customized workspace for your need</p>
                                        <a href="/enquiry" className="btn btn-one btn-anim w-100" style={{ color: '#fff' }}>Enquiry</a>
                                    </div>
                                </div>
                            </form>
                        </div>
